          ...
          <div>
            ...
            <div className="space-y-3">
              ...
              <div className="flex gap-3">
                ...
                <a href="https://www.google.com/maps/dir/?api=1&destination=7VG6+3RQ,+Bizerte,+Tunisia" target="_blank" rel="noopener noreferrer" className="font-body text-background/80 hover:text-background transition-colors">
                  Google Maps
                </a>
              </div>
            </div>
